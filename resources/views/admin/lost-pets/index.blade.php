                    ...
                    <table id="lost-pets-list-table" class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('admin_pet.lost.index.table.size')</th>
                                    <th>@lang('admin_pet.lost.index.table.location')</th>
                                    <th>@lang('admin_pet.lost.index.table.contact_phone')</th>
                                ...
                                <tr id="lists-search-row">
                                    <td>
                                        <select class="form-control" id="is_published" name="is_published">
                                            <option value="" selected> {{ trans('admin_pet.lost.index.table.select') }}</option>
                                    ...
                                    <td>
                                        <select class="form-control" id="is_found" name="is_found">
                                            <option value="" selected> {{ trans('admin_pet.lost.index.table.select') }}</option>
                                            @foreach (trans('enums.booleans') as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ isset($searchParams['is_found']) ?
                                                        (($searchParams['is_found'] == $key) ? 'selected' : '') :
                                                        ''
                                                    }}
                                                >
                                                    {{ $value }}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin-lost-pet-list') }}" class="btn btn-default">
