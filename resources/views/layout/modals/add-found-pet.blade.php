        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                            ...
                            <label id="upload-label" for="upload" class="font-weight-light text-muted">@lang('dictionary.files.choose')
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary search-btn">@lang('dictionary.found_pets.modal.add_new')</button>
                </div>
            </div>
        </div>
    </div>
